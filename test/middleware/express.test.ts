...
describe('Express middleware', () => {
  ...
  it('includes request_summary with SQL data', async () => {
    ...
    const entry = collector.received.find(
      (e) => (e as Record<string, unknown>).request_summary,
  ...
  it('skips ignored paths', async () => {
    ...
    const requestEntries = collector.received.filter(
      (e) => (e as Record<string, unknown>).message && ((e as Record<string, unknown>).message as string).includes('/health'),
    );
